...
//            ->setVersion('1.0.0')
    ...
    {
        ArrayTools::getAndCall($params, "description", [$command, "setDescription"]);
        ArrayTools::getAndCall($params, "handler", [$this, "setHandlerFromString"], [$command]);
        if ($command instanceof SubCommandConfig) {
            ArrayTools::getAndCall($params, "handlerMethod", [$command, "setHandlerMethod"]);
        }
